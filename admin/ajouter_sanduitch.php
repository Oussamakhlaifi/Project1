...
if(isset($_POST['upload'])){
    ...
    $insert = "INSERT INTO  sanduitch (name, price ,image) VALUES ('$NAME','$PRICE','$image_up')";
    ...
    <div class="row">
      <div class="col-sm-6 text-black">
        ...
        <div class="px-5 ms-xl-4">
          ...
          <span class="h1 fw-bold mb-0" style="margin-right:250px;">sandwich</span>
        </div>
        <div class="d-flex align-items-center h-custom-2 px-5 ms-xl-4 mt-5 pt-5 pt-xl-0 mt-xl-n5">
            <form action="" method="post" enctype="multipart/form-data" style="width: 23rem;">
            <h3 class="fw-normal mb-3 pb-3" style="letter-spacing: 1px;">Ajouter sandwich</h3>
