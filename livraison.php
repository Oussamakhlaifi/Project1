...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Insérer le tableau dans la base de données
    $sql = "INSERT INTO livraison (name, address, address2, number) VALUES ('".$name."', '".$adresse."', '".$adresse2."', '".$numero."')";
...
<div class="container">
  ...
  <div class="py-5 text-center">
      <h2>Livraison jusqu'a chez vous </h2>
      <p class="lead">Il une quipe de livraison à votre diposition  </p>
    </div>
      ...
      <div class="col-md-7 col-lg-8">
        ...
        <form class="needs-validation" method="post" novalidate>
          <div class="row g-3">
            ...
            <div class="col-12">
              <label for="number" class="form-label">Votre numero de telephone </label>
              <input type="numbre" class="form-control" name="number" id="number" placeholder="mettez votre numero de telephone">
            </div>
